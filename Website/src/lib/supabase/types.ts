  ...
  public: {
    Tables: {
      ...
      card_options: {
        Row: {
          id: string;
          kind: "set" | "variant" | "language" | "release_year" | "brand" | "catalog_category" | "print_label";
          name: string;
          created_at: string;
          updated_at: string;
        };
