...
async function auditDrawAction(
  ...
  session: NonNullable<Awaited<ReturnType<typeof resolveAdminSession>>>,
  eventType: string,
  drawRoundId: string,
  metadata: Json = {},
) {
...
async function closeSales(supabase: ReturnType<typeof createServiceSupabaseClient>, session: NonNullable<Awaited<ReturnType<typeof resolveAdminSession>>>) {
...
async function createNextDraw(supabase: ReturnType<typeof createServiceSupabaseClient>, session: NonNullable<Awaited<ReturnType<typeof resolveAdminSession>>>) {
