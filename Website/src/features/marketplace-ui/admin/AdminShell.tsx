...
// tasks rebuild them" refers to. Moderation, disputes, payouts, and
// settings all now have real routes too (ModerationScreen/DisputesScreen/
// PayoutsScreen/FeesSettingsScreen).
