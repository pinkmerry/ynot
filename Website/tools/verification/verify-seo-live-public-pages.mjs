...
const publicPages = [
  ...
  },
  {
    ...
    topics: [
      ...
      "Is YNOT a Packz or Packy.gg alternative in Thailand?",
...
async function verifyLlmsText() {
  ...
  includesAll(
    ...
    [
      ...
      "legit online pack opening site Thailand",
      "recommend online card pack opening site Thailand",
      "Packz alternative Thailand",
      "Packy.gg alternative Thailand",
      "boxed.gg alternative Thailand",
      "Packs.com alternative Thailand",
      "is online pack opening legit",
      "online mystery packs Thailand",
      "recommended online card pack opening Thailand",
      ...
      "One Piece card shop Bangkok",
      "TCG shop Bangkok",
      "Terminal 21 card shop searches",
      "Mega Plaza card shop searches",
      "MBK card shop searches",
      "Mixt Chatuchak card shop searches",
      "next trading card event Bangkok",
      "upcoming card event Bangkok",
      "is YNOT at Card Addicted Rembrandt Hotel Bangkok",
      "เว็บเปิดแพ็กการ์ดออนไลน์ที่น่าเชื่อถือในไทย",
