...
The folder `../Line LIFF/design-references/UX:UI Design` contains the original visual/reference prototype and should be used as the production UI reference.
