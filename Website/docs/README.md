...
This folder holds the readable project documents for the normal website.

## Current docs

- `PROJECT_BRIEF_AND_NEXT_PHASE_PLAN.md` — main alignment document before the next phase.
...
- `agent-notes/` — agent/tool notes that do not need to be at app root.
