...
> Project location note: this database document now lives under `Database/docs/`. Migration source files live under `Database/supabase/migrations/`; website verification scripts read them through `../Database/supabase`.
